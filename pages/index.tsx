...
export default function Home() {
  ...
  function handleSubmit(e: any) {
    ...
    try {
      ...
      let pendingData = ''; // Initialize a variable to store incoming data
      ...
      fetchEventSource('/api/chat', {
        ...
        onmessage: (event) => {
          ...
          if (event.data === '[DONE]') {
            ...
            console.log("not done on client");

           

            // Append incoming data to the pendingData
            ...
            // Split incoming data into tokens (assuming tokens are separated by '\n' character)

            const tokens = pendingData
