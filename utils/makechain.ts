...
const QA_PROMPT = PromptTemplate.fromTemplate(
  ...
  Your goal is to provide insightful answers using this context. When addressing technical concepts, ensure elaborate explanations with examples. Include in-text APA citations for your answer in BOLD.
